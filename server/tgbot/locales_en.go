...
var msgEN = map[string]string{
	...
	"help_short":                   "Bottom keyboard or /more. Type / for the full command list.",
	"help_slash_hint":              "Type / for the full command list (admin commands appear if you are on the whitelist).",
	"help_cancel":                  "Cancel pending settings, preset, search, or tool pick",
	"help_menu_section":            "Menu",
	"help_all_commands":            "All commands",
	"menu_welcome":                 "Use the keyboard below. Library opens your torrents in one message — pick an item for Files / Status / Link. Extra tools: ⋯ More or /more.",
	"menu_kb_placeholder":          "Library, Search, or paste a magnet",
	"menu_act_lang":                "Language",
	"menu_library":                 "📚 Library",
	"menu_search":                  "🔍 Search",
	"menu_status":                  "📊 Status",
	"menu_add":                     "➕ Add",
	"menu_more":                    "⋯ More",
	"menu_more_title":              "More",
	"menu_section_lib":             "Library",
	"menu_section_tools":           "Tools",
	"menu_section_links":           "Links",
	"menu_section_admin":           "Admin",
	"menu_export":                  "Export",
	"menu_import":                  "Import",
	"menu_help":                    "Help",
	"menu_settings":                "Settings",
	"menu_open_web":                "Open Web",
	"menu_search_hint":             "Send a search query as the next message (or /search &lt;query&gt;). /cancel to abort.",
	"menu_search_pending":          "🔍 Send your search query now…",
	"menu_import_hint":             "Send: /import and paste magnets or torrs:// (one per line)",
	"menu_pick_torrent":            "Open the library and pick a torrent first, or use the command with a hash/number.",
	"menu_back":                    "← Back",
	"btn_back_list":                "← Library",
	"btn_back_torrent":             "← Torrent",
	"cancel_nothing":               "Nothing to cancel",
	"cmd_desc_start":               "Main menu",
	"cmd_desc_help":                "Help and user ID",
	"cmd_desc_list":                "Library",
	"cmd_desc_add":                 "Add torrent",
	"cmd_desc_search":              "Search torrents",
	"cmd_desc_more":                "More actions",
	"cmd_desc_cancel":              "Cancel pending input",
	"cmd_desc_lang":                "Language RU|EN",
	"cmd_desc_clear":               "Remove all torrents",
	"cmd_desc_remove":              "Remove a torrent",
	"cmd_desc_drop":                "Disconnect torrent",
	"cmd_desc_status":              "Torrent status",
	"cmd_desc_cache":               "Cache stats",
	"cmd_desc_preload":             "Preload a file",
	"cmd_desc_hash":                "Show info hashes",
	"cmd_desc_set":                 "Set torrent title",
	"cmd_desc_setcat":              "Set category",
	"cmd_desc_link":                "Play and stream URLs",
	"cmd_desc_play":                "Play URLs (alias of /link)",
	"cmd_desc_m3u":                 "M3U playlist",
	"cmd_desc_m3uall":              "M3U of all torrents",
	"cmd_desc_next":                "Next unwatched episode",
	"cmd_desc_rutor":               "Search RuTor",
	"cmd_desc_torznab":             "Search Torznab",
	"cmd_desc_export":              "Export magnets",
	"cmd_desc_import":              "Import magnets",
	"cmd_desc_categories":          "Category counts",
	"cmd_desc_server":              "Server info",
	"cmd_desc_stats":               "Summary stats",
	"cmd_desc_stat":                "Detailed status",
	"cmd_desc_viewed":              "Viewed files",
	"cmd_desc_ffp":                 "FFprobe metadata",
	"cmd_desc_speedtest":           "Download speed test",
	"cmd_desc_snake":               "Cache visualization",
	"cmd_desc_queue":               "Telegram upload queue",
	"cmd_desc_echo":                "Bot version",
	"cmd_desc_db":                  "Database dump",
	"cmd_desc_id":                  "Show your user ID",
	"cmd_desc_settings":            "Settings (admin)",
	"cmd_desc_preset":              "Preset (admin)",
	"cmd_desc_shutdown":            "Shutdown (admin)",
	"menu_act_clear":               "Clear all",
	"menu_act_hash":                "Hashes",
	"menu_act_categories":          "Categories",
	"menu_act_snake":               "Snake (cache)",
	"menu_act_preload":             "Preload",
	"menu_act_queue":               "Upload queue",
	"menu_act_ffp":                 "FFprobe",
	"menu_act_speedtest":           "Speedtest",
	"menu_act_echo":                "Version",
	"menu_act_db":                  "DB dump",
	"menu_act_viewed":              "Viewed",
	"menu_act_server":              "Server",
	"menu_act_stats":               "Summary stats",
	"menu_act_stat":                "Detailed status",
	"menu_act_m3uall":              "M3U all",
	"menu_act_cache":               "Cache",
	"menu_act_preset":              "Preset",
	"menu_act_shutdown":            "Shutdown",
	"help_main":                    "Main",
	...
	"btn_no":                       "No",
	"help_help":                    "This help",
	"help_list":                    "/list [category] - Library hub",
	...
	"help_links":                   "/link, /play, /m3u, /m3uall [category]",
	...
	"help_categories":              "/categories, /list [category] - Filter library",
	"help_rutor":                   "/rutor - Search RuTor",
	"help_m3uall":                  "/m3uall [category] - M3U of all torrents",
	...
	"settings_more":                "More",
	"settings_back":                "Back",
	"settings_back_more":           "Back to More",
	...
	"settings_tgl_upload":          "Upload",
	"settings_tgl_dht":             "DHT",
	"settings_tgl_pex":             "PEX",
	"settings_tgl_tcp":             "TCP",
	"settings_tgl_utp":             "uTP",
	"settings_tgl_upnp":            "UPnP",
	"settings_tgl_encrypt":         "Encrypt",
	"settings_tgl_debug":           "Debug",
	"settings_tgl_cachedrop":       "Drop cache",
	"settings_tgl_responsive":      "Responsive",
	"settings_tgl_usedisk":         "Use disk",
	"settings_tgl_fsactive":        "FS active",
	"settings_tgl_timecode":        "Timecode",
	"settings_tgl_lpd":             "LPD",
	"settings_tgl_lpdv6":           "LPD IPv6",
	"settings_tgl_cache":           "Cache",
	"settings_tgl_preload":         "Preload",
	"settings_tgl_readahead":       "Read-ahead",
	"settings_tgl_conn":            "Connections",
	"settings_tgl_port":            "Port",
	"settings_tgl_timeout":         "Timeout",
	"settings_tgl_down":            "Download",
	"settings_tgl_up":              "Upload rate",
	"settings_tgl_retr":            "Retrackers",
	"settings_tmdb_image":          "TMDB images",
	...
	"menu_act_next":                "Next episode",
	"cat_all":                      "All",
	"cat_movie":                    "Movie",
	"cat_tv":                       "TV",
	"cat_music":                    "Music",
	"cat_other":                    "Other",
	"cat_clear":                    "Clear category",
	"cat_pick":                     "📁 Pick a category for:\n<b>%s</b>",
	"card_category":                "Category",
	"setcat_usage":                 "ℹ️ Usage: /setcat &lt;hash|index&gt; &lt;movie|tv|music|other|-&gt;",
	"setcat_done":                  "✅ Category: <code>%s</code>",
	"setcat_saved":                 "✅ Category saved",
	"list_empty_cat":               "📭 No torrents in %s",
	"categories_filter_hint":       "Tap a category to filter /list",
	"link_play_dual":               "🔗 Short:\n<code>%s</code>\n\n🎬 Stream:\n<code>%s</code>",
	"next_none":                    "📭 No unwatched episode found",
	"next_episode":                 "Episode",
	"next_file":                    "file",
	"next_remaining":               "Remaining",
	"next_matched":                 "matched",
	"next_short":                   "Short play URL",
	"next_long":                    "Stream URL",
	"next_m3u":                     "M3U",
	"next_mark":                    "Mark viewed",
	"next_marked":                  "✅ Marked viewed",
	"help_next":                    "/next [query|hash] [category] - Next unwatched episode",
	"bot_short":                    "TorrServer library and streams",
	"bot_desc":                     "Add torrents, search, play, and manage your TorrServer library from Telegram.",
	"btn_copy_hash":                "Hash",
	"btn_copy_play":                "Play",
	"btn_copy_magnet":              "Magnet",
	"btn_copy_stream":              "Stream",
	"btn_copy_m3u":                 "M3U",
	"copy_too_long":                "Stream URL is too long for a copy button — select the text above.",
	"help_copy_play":               "Play copies the short /play URL — paste it into VLC or Infuse. Mini App (HTTPS) has player buttons.",
	"menu_search_inline":           "Inline search",
	"menu_search_inline_hint":      "Or tap to search inline in this chat",
	"help_deeplink":                "Deep link: %s",
	"help_miniapp":                 "Mini App: chat menu button next to the text field (HTTPS HostWeb)",
	"start_unknown":                "Unknown start link. Opening the menu.",
	"start_multi_hash":             "Several torrents match that prefix:",
	"inline_open_bot":              "Open TorrServer",
	"inline_add_private":           "Adding: %s",
	"inline_pick_hint":             "Tap Inline search and pick a result, or send the query as the next message.",
	"inline_empty_search":          "Nothing found for «%s»",
	"inline_empty_disabled":        "Search is disabled in settings",
	"add_reply_placeholder":        "magnet, hash, or torrs://",
	"search_reply_placeholder":     "Search query",
}
