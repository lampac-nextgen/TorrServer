...
var msgEN = map[string]string{
	...
	"help_short":                   "Use the bottom menu or tap a torrent in the library. Full commands: /help in BotFather list.",
	"help_cancel":                  "Cancel pending settings/preset input",
	"menu_welcome":                 "Use the keyboard below. Library opens your torrents in one message — pick an item for Files / Status / Link.",
	"menu_library":                 "📚 Library",
	"menu_search":                  "🔍 Search",
	"menu_status":                  "📊 Status",
	"menu_add":                     "➕ Add",
	"menu_more":                    "⋯ More",
	"menu_more_title":              "More actions",
	"menu_export":                  "Export",
	"menu_import":                  "Import",
	"menu_help":                    "Help",
	"menu_settings":                "Settings",
	"menu_open_web":                "Open Web",
	"menu_search_hint":             "Send: /search &lt;query&gt;",
