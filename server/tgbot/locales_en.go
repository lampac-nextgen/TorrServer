...
var msgEN = map[string]string{
	...
	"btn_copy_play":                "Copy play",
	"btn_copy_magnet":              "Copy magnet",
	"btn_copy_stream":              "Copy stream",
	"btn_copy_m3u":                 "Copy M3U",
	"help_copy_play":               "Copy play copies the short /play URL — paste it into VLC or Infuse. Mini App (HTTPS) has player buttons.",
