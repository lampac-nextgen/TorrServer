...
var msgRU = map[string]string{
	...
	"help_short":                   "Нижнее меню или выбор торрента в библиотеке. Список команд — в BotFather.",
	"help_cancel":                  "Отменить ввод настроек/пресета",
	"menu_welcome":                 "Клавиатура внизу. Библиотека — один список; нажмите торрент для Файлов / Статуса / Ссылки.",
	"menu_library":                 "📚 Библиотека",
	"menu_search":                  "🔍 Поиск",
	"menu_status":                  "📊 Статус",
	"menu_add":                     "➕ Добавить",
	"menu_more":                    "⋯ Ещё",
	"menu_more_title":              "Дополнительно",
	"menu_export":                  "Экспорт",
	"menu_import":                  "Импорт",
	"menu_help":                    "Справка",
	"menu_settings":                "Настройки",
	"menu_open_web":                "Открыть Web",
	"menu_search_hint":             "Отправьте: /search &lt;запрос&gt;",
