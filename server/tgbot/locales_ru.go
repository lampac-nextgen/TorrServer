...
var msgRU = map[string]string{
	...
	"btn_copy_hash":                "Копировать хэш",
	"btn_copy_play":                "Копировать play",
	"btn_copy_magnet":              "Копировать магнит",
	"btn_copy_stream":              "Копировать поток",
	"btn_copy_m3u":                 "Копировать M3U",
	"help_copy_play":               "«Копировать play» копирует короткую ссылку /play — вставьте её в VLC или Infuse. Mini App (HTTPS) открывает плееры.",
