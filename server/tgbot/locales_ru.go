...
var msgRU = map[string]string{
	...
	"help_short":                   "Нижняя клавиатура или /more. Введите / для полного списка команд.",
	"help_slash_hint":              "Введите / для полного списка команд (админские видны, если вы в WhiteIds).",
	"help_cancel":                  "Отменить ввод настроек, пресета, поиска или выбор торрента",
	"help_menu_section":            "Меню",
	"help_all_commands":            "Все команды",
	"menu_welcome":                 "Клавиатура внизу. Библиотека — один список; нажмите торрент для Файлов / Статуса / Ссылки. Дополнительно: ⋯ Ещё или /more.",
	"menu_kb_placeholder":          "Библиотека, поиск или вставьте magnet",
	"menu_act_lang":                "Язык",
	...
	"menu_more":                    "⋯ Ещё",
	"menu_more_title":              "Ещё",
	"menu_section_lib":             "Библиотека",
	"menu_section_tools":           "Инструменты",
	"menu_section_links":           "Ссылки",
	"menu_section_admin":           "Админ",
	"menu_export":                  "Экспорт",
	"menu_import":                  "Импорт",
	"menu_help":                    "Справка",
	"menu_settings":                "Настройки",
	"menu_open_web":                "Открыть Web",
	"menu_search_hint":             "Следующим сообщением отправьте поисковый запрос (или /search &lt;запрос&gt;). /cancel — отмена.",
	"menu_search_pending":          "🔍 Отправьте поисковый запрос…",
	"menu_import_hint":             "Отправьте: /import и вставьте magnets или torrs:// (по одному на строку)",
	"menu_pick_torrent":            "Сначала откройте библиотеку и выберите торрент, либо укажите hash/номер в команде.",
	"menu_back":                    "← Назад",
	"btn_back_list":                "← Библиотека",
	"btn_back_torrent":             "← Торрент",
	"cancel_nothing":               "Нечего отменять",
	"cmd_desc_start":               "Главное меню",
	"cmd_desc_help":                "Справка и user ID",
	"cmd_desc_list":                "Библиотека",
	"cmd_desc_add":                 "Добавить торрент",
	"cmd_desc_search":              "Поиск торрентов",
	"cmd_desc_more":                "Дополнительно",
	"cmd_desc_cancel":              "Отменить ввод",
	"cmd_desc_lang":                "Язык RU|EN",
	"cmd_desc_clear":               "Удалить все торренты",
	"cmd_desc_remove":              "Удалить торрент",
	"cmd_desc_drop":                "Отключить торрент",
	"cmd_desc_status":              "Статус торрента",
	"cmd_desc_cache":               "Статистика кеша",
	"cmd_desc_preload":             "Прелоад файла",
	"cmd_desc_hash":                "Показать info hash",
	"cmd_desc_set":                 "Задать название",
	"cmd_desc_setcat":              "Задать категорию",
	"cmd_desc_link":                "Ссылки play и stream",
	"cmd_desc_play":                "Ссылки play (алиас /link)",
	"cmd_desc_m3u":                 "Плейлист M3U",
	"cmd_desc_m3uall":              "M3U всех торрентов",
	"cmd_desc_next":                "Следующая серия",
	"cmd_desc_rutor":               "Поиск RuTor",
	"cmd_desc_torznab":             "Поиск Torznab",
	"cmd_desc_export":              "Экспорт магнитов",
	"cmd_desc_import":              "Импорт магнитов",
	"cmd_desc_categories":          "Счётчики категорий",
	"cmd_desc_server":              "Информация о сервере",
	"cmd_desc_stats":               "Сводная статистика",
	"cmd_desc_stat":                "Детальный статус",
	"cmd_desc_viewed":              "Просмотренные файлы",
	"cmd_desc_ffp":                 "Метаданные FFprobe",
	"cmd_desc_speedtest":           "Тест скорости загрузки",
	"cmd_desc_snake":               "Визуализация кеша",
	"cmd_desc_queue":               "Очередь загрузки в Telegram",
	"cmd_desc_echo":                "Версия бота",
	"cmd_desc_db":                  "Дамп базы",
	"cmd_desc_id":                  "Показать ваш user ID",
	"cmd_desc_settings":            "Настройки (админ)",
	"cmd_desc_preset":              "Пресет (админ)",
	"cmd_desc_shutdown":            "Выключение (админ)",
	"menu_act_clear":               "Очистить всё",
	"menu_act_hash":                "Хэши",
	"menu_act_categories":          "Категории",
	"menu_act_snake":               "Змейка (кеш)",
	"menu_act_preload":             "Прелоад",
	"menu_act_queue":               "Очередь загрузки",
	"menu_act_ffp":                 "FFprobe",
	"menu_act_speedtest":           "Speedtest",
	"menu_act_echo":                "Версия",
	"menu_act_db":                  "Дамп БД",
	"menu_act_viewed":              "Просмотренные",
	"menu_act_server":              "Сервер",
	"menu_act_stats":               "Сводная статистика",
	"menu_act_stat":                "Детальный статус",
	"menu_act_m3uall":              "M3U всех",
	"menu_act_cache":               "Кеш",
	"menu_act_preset":              "Пресет",
	"menu_act_shutdown":            "Выключение",
	"help_main":                    "Основные",
	...
	"help_list":                    "/list [категория] - Библиотека",
	...
	"help_remove":                  "/remove, /drop, /set, /setcat, /status, /cache, /queue",
	"help_links":                   "/link, /play, /m3u, /m3uall [категория]",
	...
	"help_other_cmd":               "/viewed, /next, /ffp, /speedtest, /preload, /snake",
	...
	"help_categories":              "/categories, /list [категория] - Фильтр библиотеки",
	"help_rutor":                   "/rutor - Поиск RuTor",
	"help_m3uall":                  "/m3uall [категория] - M3U всех торрентов",
	...
	"settings_more":                "Ещё",
	"settings_back":                "Назад",
	"settings_back_more":           "К разделу Ещё",
	...
	"settings_tgl_rutor":           "RuTor",
	"settings_tgl_torznab":         "Torznab",
	"settings_tgl_dlna":            "DLNA",
	"settings_tgl_bonjour":         "Bonjour",
	"settings_tgl_ipv6":            "IPv6",
	"settings_tgl_upload":          "Раздача",
	"settings_tgl_dht":             "DHT",
	"settings_tgl_pex":             "PEX",
	"settings_tgl_tcp":             "TCP",
	"settings_tgl_utp":             "uTP",
	"settings_tgl_upnp":            "UPnP",
	"settings_tgl_encrypt":         "Шифрование",
	"settings_tgl_debug":           "Отладка",
	"settings_tgl_cachedrop":       "Удалять кэш",
	"settings_tgl_responsive":      "Адаптивный",
	"settings_tgl_usedisk":         "Диск",
	"settings_tgl_fsactive":        "Активные в FS",
	"settings_tgl_timecode":        "Таймкод",
	"settings_tgl_lpd":             "LPD",
	"settings_tgl_lpdv6":           "LPD IPv6",
	"settings_tgl_cache":           "Кэш",
	"settings_tgl_preload":         "Прелоад",
	"settings_tgl_readahead":       "Опережение",
	"settings_tgl_conn":            "Соединения",
	"settings_tgl_port":            "Порт",
	"settings_tgl_timeout":         "Таймаут",
	"settings_tgl_down":            "Загрузка",
	"settings_tgl_up":              "Отдача",
	"settings_tgl_retr":            "Ретрекеры",
	"settings_tmdb_image":          "Картинки TMDB",
	...
	"menu_act_next":                "Следующая серия",
	"cat_all":                      "Все",
	"cat_movie":                    "Фильм",
	"cat_tv":                       "Сериал",
	"cat_music":                    "Музыка",
	"cat_other":                    "Другое",
	"cat_clear":                    "Сбросить категорию",
	"cat_pick":                     "📁 Выберите категорию для:\n<b>%s</b>",
	"card_category":                "Категория",
	"setcat_usage":                 "ℹ️ Использование: /setcat &lt;hash|номер&gt; &lt;movie|tv|music|other|-&gt;",
	"setcat_done":                  "✅ Категория: <code>%s</code>",
	"setcat_saved":                 "✅ Категория сохранена",
	"list_empty_cat":               "📭 Нет торрентов в %s",
	"categories_filter_hint":       "Нажмите категорию, чтобы фильтровать /list",
	"link_play_dual":               "🔗 Короткая:\n<code>%s</code>\n\n🎬 Поток:\n<code>%s</code>",
	"next_none":                    "📭 Непросмотренных серий не найдено",
	"next_episode":                 "Серия",
	"next_file":                    "файл",
	"next_remaining":               "Осталось",
	"next_matched":                 "совпало",
	"next_short":                   "Короткая ссылка",
	"next_long":                    "Ссылка на поток",
	"next_m3u":                     "M3U",
	"next_mark":                    "Отметить просмотр",
	"next_marked":                  "✅ Отмечено",
	"help_next":                    "/next [запрос|hash] [категория] — следующая непросмотренная серия",
	"bot_short":                    "Библиотека и трансляции TorrServer",
	"bot_desc":                     "Добавляйте торренты, ищите, смотрите и управляйте библиотекой TorrServer из Telegram.",
	"btn_copy_hash":                "Хэш",
	"btn_copy_play":                "Play",
	"btn_copy_magnet":              "Magnet",
	"btn_copy_stream":              "Stream",
	"btn_copy_m3u":                 "M3U",
	"copy_too_long":                "URL потока слишком длинный для кнопки копирования — выделите текст выше.",
	"help_copy_play":               "Play копирует короткую ссылку /play — вставьте её в VLC или Infuse. Mini App (HTTPS) открывает плееры.",
	"menu_search_inline":           "Inline-поиск",
	"menu_search_inline_hint":      "Или нажмите для поиска inline в этом чате",
	"help_deeplink":                "Deep link: %s",
	"help_miniapp":                 "Mini App: кнопка меню чата рядом с полем ввода (HTTPS HostWeb)",
	"start_unknown":                "Неизвестная стартовая ссылка. Открываю меню.",
	"start_multi_hash":             "Несколько торрентов с таким префиксом:",
	"inline_open_bot":              "Открыть TorrServer",
	"inline_add_private":           "Добавляю: %s",
	"inline_pick_hint":             "Нажмите Inline-поиск и выберите результат или отправьте запрос следующим сообщением.",
	"inline_empty_search":          "Ничего не найдено по «%s»",
	"inline_empty_disabled":        "Поиск выключен в настройках",
	"add_reply_placeholder":        "magnet, хэш или torrs://",
	"search_reply_placeholder":     "Поисковый запрос",
}
