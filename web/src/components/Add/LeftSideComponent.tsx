...
interface LeftSideComponentProps {
  setIsUserInteractedWithPoster: (value: boolean) => void
  setSelectedFile: (files: File | File[] | null) => void
  torrentSource: string
  setTorrentSource: Dispatch<SetStateAction<string>>
}
...
export default function LeftSideComponent({
  ...
  const handleTorrentSourceChange = ({ target: { value } }: ChangeEvent<HTMLInputElement>) => setTorrentSource(value)
